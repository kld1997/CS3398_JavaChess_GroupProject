...
/**
 *  capture / play back sample will record audio in different formats then 
 *  play back the recorded audio.
 *  The captured audio can be saved as a: WAVE, AU, AIFF
 *  Or an audio file of the same category can be played as well
 * @author feliper_dot
 *
 */

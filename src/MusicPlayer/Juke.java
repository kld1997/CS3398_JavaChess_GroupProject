...
//        gainSlider.setEnabled(true);        
    ...
    public class PlaybackMonitor extends JPanel implements Runnable {
        ...
        String welcomeStr = "Welcome to the chess++ music Player";
        Thread pbThread;
    ...
    class JukeTable extends JPanel implements ActionListener {
        ...
        public JukeTable() {
            ...
            String Starters = "/Users/feliper_dot/eclipse-workspace/audioPlayer/";
            if (Starters.startsWith("http") || Starters.startsWith("file")) {
                try {
                    sounds.add(new URL(Starters));
